  ...
  preset: {
    ...
    zones: [
      ...
      },
      {
        ...
        radius: { tiles: 6, xDistort: 5, yTiles: 0.4 },
        shapes: {
          clouds: { count: count(4, 0, 0), quota: S.clouds },
          snow: { count: count(3, 0, 0), quota: S.snow },
        },
      },
      {
      ...
      },
      {
        ...
        band: "sky",
        center: { x: 0.45, y: 0.8 },
        radius: { tiles: 3, xDistort: 4, yTiles: 0.5 },
        shapes: {
          clouds: { count: count(2, 0, 0), quota: S.clouds },
        },
      },
      ...
      },
      {
        ...
        shapes: {
          trees: { count: count(6, 6, 12), quota: S.trees },
        },
      },
      {
        id: "mid-far-trees",
      ...
      },
      {
        ...
        shapes: {
          trees: { count: count(4, 4, 8), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          ...
          car: { count: count(1, 2, 3), quota: S.car },
          bus: { count: count(1, 1, 1), quota: S.bus },
          power: { count: count(1, 1, 2), quota: FLAT_QUOTA },
          clouds: { count: count(0, 0, 2), quota: FLAT_QUOTA },
      ...
      },
      {
        ...
        shapes: {
          villa: { count: count(2, 1, 4), quota: S.villa },
          trees: { count: count(1, 4, 6), quota: S.trees },
      ...
      },
      {
        ...
        radius: { tiles: 6, xDistort: 4, yDistort: 2 },
        shapes: {
          villa: { count: count(2, 3, 8), quota: S.villa },
          trees: { count: count(3, 4, 12), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          ...
          house: { count: count(1, 1, 2), quota: S.house },
          trees: { count: count(6, 8, 8), quota: S.trees },
          car: { count: count(1, 2, 1), quota: S.car },
          bus: { count: count(1, 1, 1), quota: S.bus },
        },
      },
      {
        ...
        shapes: {
          ...
          trees: { count: count(1, 6, 8), quota: S.trees },
      ...
      },
      {
        ...
        band: "ground",
        center: { x: 0.9, y: 0.5 },
        radius: { tiles: 6, xDistort: 4, yDistort: 0.7 },
        shapes: {
          villa: { count: count(2, 1, 3), quota: S.villa },
          trees: { count: count(1, 2, 5), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          ...
          villa: { count: count(1, 2, 3), quota: S.villa },
          trees: { count: count(2, 3, 6), quota: S.trees },
          car: { count: count(1, 1, 0), quota: S.car },
          power: { count: count(1, 0, 0), quota: FLAT_QUOTA },
          carFactory: { count: count(0, 1, 2), quota: S.carFactory },
        },
      },
      {
        id: "right-community",
        ...
        shapes: {
          trees: { count: count(4, 0, 3), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          ...
          trees: { count: count(3, 6, 4), quota: S.trees },
          car: { count: count(0, 1, 2), quota: S.car },
      ...
      },
      {
        ...
        shapes: {
          ...
          house: { count: count(0, 2, 2), quota: S.house },
      ...
      },
      {
        ...
        shapes: {
          trees: { count: count(2, 3, 0), quota: S.trees },
        },
      },
      {
        id: "left-close-trees",
        ...
        radius: { tiles: 5, xDistort: 6, yDistort: 0.3 },
        shapes: {
          trees: { count: count(1, 3, 4), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          ...
          house: { count: count(0, 0, 2), quota: S.house },
          villa: { count: count(0, 2, 3), quota: S.villa },
          trees: { count: count(1, 0, 6), quota: S.trees },
          car: { count: count(0, 1, 2), quota: S.car },
          carFactory: { count: count(1, 1, 2), quota: S.carFactory },
          bus: { count: count(1, 1, 1), quota: S.bus },
          power: { count: count(0, 1, 1), quota: FLAT_QUOTA },
        },
      },
      {
        ...
        shapes: {
          ...
          trees: { count: count(1, 6, 0), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          sea: { count: count(1, 1, 1), quota: FLAT_QUOTA },
          villa: { count: count(1, 2, 2), quota: S.villa },
      ...
      },
      {
        ...
        shapes: {
          villa: { count: count(3, 3, 4), quota: S.villa },
          house: { count: count(1, 3, 2), quota: S.house },
          trees: { count: count(4, 6, 6), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          ...
          trees: { count: count(0, 4, 6), quota: S.trees },
      ...
      },
      {
        ...
        shapes: {
          villa: { count: count(0, 0, 2), quota: S.villa },
          house: { count: count(0, 1, 3), quota: S.house },
          trees: { count: count(0, 3, 3), quota: S.trees },
          car: { count: count(0, 0, 1), quota: S.car },
        },
      },
      {
