  ...
  preset: {
    ...
    zones: [
      ...
      },
      {
        ...
        band: "ground",
        center: { x: 0, y: 0.9 },
        radius: { tiles: 4, xDistort: 1, yDistort: 3 },
        shapes: {
          villa: { count: count(1, 0, 0), quota: S.villa }, 
          house: { count: count(2, 0, 0), quota: S.house },
      ...
      },
      {
        ...
        shapes: {
          carFactory: { count: count(0, 0, 1), quota: FLAT_QUOTA },
          villa: { count: count(0, 0, 1), quota: S.villa },
        },
      },
      {
      ...
      },
      {
        ...
        shapes: {
          ...
          trees: { count: count(2, 2, 4), quota: S.trees },
          car: { count: count(1, 1, 3), quota: S.car },
          bus: { count: count(1, 1, 1), quota: S.bus },
        },
      },
