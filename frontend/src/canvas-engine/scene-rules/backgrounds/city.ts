...
const CITY_BACKGROUND: BackgroundSpec = {
  ...
  overlay: {
    ...
    to: { xK: 0.5, yK: 1.0 },
    stops: [
      { rgba: "rgba(158, 222, 248, 1.0)" },
      { rgba: "rgba(186, 232, 255, 0.99)", oscK: { amp: 0.03, hz: 0.015 } },
      { rgba: "rgba(214, 242, 255, 0.97)" },
      { k: "visualHorizon", rgba: "rgba(255, 236, 166, 0.95)" },
      { k: "visualHorizon", rgba: "rgba(108, 214, 184, 0.95)", liveBlend: [0.04, 0.12] },
      { rgba: "rgba(82, 184, 146, 0.97)", liveBlend: [0.02, 0.08] },
      { rgba: "rgba(82, 184, 146, 0.97)" },
...
const CITY_BACKGROUND_DARK: BackgroundSpec = {
  ...
  overlay: {
    ...
    to: { xK: 0.5, yK: 1.0 },
    stops: [
      { rgba: "rgba(18, 26, 62, 1.0)" },
      { rgba: "rgba(41, 57, 113, 0.98)", oscK: { amp: 0.03, hz: 0.015 } },
      { rgba: "rgba(36, 60, 116, 0.95)" },
      { k: "visualHorizon", rgba: "rgba(64, 118, 165, 0.93)" },
      { k: "visualHorizon", rgba: "rgba(105, 157, 167, 0.95)", liveBlend: [0.04, 0.12] },
      { rgba: "rgba(76, 129, 116, 0.97)", liveBlend: [0.02, 0.08] },
      { rgba: "rgba(84, 120, 103, 0.97)" },
      { k: 0.98, rgba: "rgba(41, 40, 39, 1)" },
      { rgba: "rgba(41, 40, 39, 1)" },
    ] as const,
  },
  stars: {
    count: [24, 36],
