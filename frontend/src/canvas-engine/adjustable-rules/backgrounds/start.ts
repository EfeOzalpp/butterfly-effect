...
const START_BACKGROUND: BackgroundSpec = {
  ...
  overlay: {
    ...
    stops: [
      ...
      { k: 0.36, rgba: "rgb(214, 242, 255)" },
      { k: 0.46, rgba: "rgb(255, 237, 195)" },
      { k: 0.48, rgba: "rgb(255, 222, 195)" },
      { k: "visualHorizon", rgba: "rgb(255, 226, 202)"},
      // ground
      { k: "visualHorizon", rgba: "rgba(108, 214, 184, 0.95)", liveBlend: [0.04, 0.12] },
      { k: 0.70, rgba: "rgba(82, 184, 103, 0.97)", liveBlend: [0.02, 0.08] },
      { k: 0.96, rgba: "rgba(112, 189, 116, 0.97)" },
...
const START_BACKGROUND_DARK: BackgroundSpec = {
  ...
  overlay: {
    ...
    stops: [
      ...
      { k: 0.42, rgba: "rgb(79, 135, 198)", rightRgba: "rgb(124, 123, 172)", liveBlend: [0.16, 0.20]  },
...
const QUESTIONNAIRE_BACKGROUND_DARK: BackgroundSpec = {
  ...
  overlay: {
    ...
    stops: [
      ...
      { k: 0.45, rgba: "rgb(90, 144, 202)", rightRgba: "rgb(60, 117, 161)", liveBlend: [0.16, 0.20]  },
