...
const START_BANDS: ShapeBands = {
    ...
    laptop: {
      ...
      house: { topK: 0.5, botK: 0.55 },
      villa: { topK: 0.5, botK: 0.55 },
      power: { topK: 0.5, botK: 0.6 },
      carFactory: { topK: 0.7, botK: 0.8 },
      car: { topK: 0.7, botK: 0.85 },
      bus: { topK: 0.7, botK: 0.85 },
      sea: { topK: 0.7, botK: 0.94 },
      trees: { topK: 0.6, botK: 0.8 },
    },
};
...
export const SHAPE_BANDS: Record<SceneLookupKey, ShapeBands> = {
  ...
  questionnaire: {
    ...
    laptop: {
      sun: { topK: 0, botK: 0.1 },
      clouds: { topK: 0.25, botK: 0.5 },
      snow: { topK: 0.5, botK: 0.6 },
      house: { topK: 0.55, botK: 0.6 },
      villa: { topK: 0.55, botK: 0.6 },
