...
const START_BANDS: ShapeBands = {
    mobile: {
      ...
      house: { topK: 0.44, botK: 0.82 },
      villa: { topK: 0.42, botK: 0.80 },
      power: { topK: 0.46, botK: 0.82 },
      carFactory: { topK: 0.50, botK: 0.84 },
      car: { topK: 0.52, botK: 0.90 },
      bus: { topK: 0.50, botK: 0.88 },
      sea: { topK: 0.66, botK: 0.94 },
      trees: { topK: 0.50, botK: 0.88 },
    },
    tablet: {
      sun: { topK: 0.0, botK: 0.1 },
      clouds: { topK: 0.14, botK: 0.28 },
      snow: { topK: 0.18, botK: 0.34 },
      house: { topK: 0.44, botK: 0.80 },
      villa: { topK: 0.42, botK: 0.78 },
      power: { topK: 0.44, botK: 0.80 },
      carFactory: { topK: 0.50, botK: 0.84 },
      car: { topK: 0.52, botK: 0.84 },
      bus: { topK: 0.50, botK: 0.84 },
      sea: { topK: 0.64, botK: 0.96 },
      trees: { topK: 0.50, botK: 0.88 },
    },
    laptop: {
      sun: { topK: 0.0, botK: 0.08 },
      clouds: { topK: 0.2, botK: 0.4 },
      snow: { topK: 0.1, botK: 0.6 },
      house: { topK: 0.55, botK: 0.78 },
      villa: { topK: 0.55, botK: 0.76 },
      power: { topK: 0.5, botK: 0.72 },
      carFactory: { topK: 0.62, botK: 0.82 },
      car: { topK: 0.7, botK: 0.86 },
      bus: { topK: 0.7, botK: 0.84 },
      sea: { topK: 0.65, botK: 0.94 },
      trees: { topK: 0.6, botK: 0.82 },
    },
};
...
export const SHAPE_BANDS: Record<SceneLookupKey, ShapeBands> = {
  ...
  questionnaire: {
    ...
    laptop: {
      ...
      house: { topK: 0.45, botK: 0.64 },
      villa: { topK: 0.45, botK: 0.64 },
      power: { topK: 0.55, botK: 0.6 },
      carFactory: { topK: 0.6, botK: 0.6 },
      car: { topK: 0.55, botK: 0.6 },
      bus: { topK: 0.6, botK: 0.8 },
