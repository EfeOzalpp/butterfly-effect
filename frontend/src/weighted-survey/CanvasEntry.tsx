...
export default function CanvasEntry({
  ...
  return (
    <div style={{ width: "70vw", height: "75vh", position: "relative", zIndex: 6 }}>
      ...
      <EngineHost id="start" open visible={visible} liveAvg={liveAvg} allocAvg={allocAvg} questionnaireOpen={questionnaireOpen} sectionOpen={sectionOpen} condAvgs={condAvgs} />
    </div>
  );
}