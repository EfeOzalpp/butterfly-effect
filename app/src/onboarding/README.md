...
Rule of thumb: onboarding owns survey input and immediate canvas feedback. Client API modules own persistence calls, app state owns global mode/reset/banner decisions, and navigation owns persistent controls.
